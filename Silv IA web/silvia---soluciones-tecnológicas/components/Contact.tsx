...
export const Contact = React.forwardRef<HTMLElement>((props, ref) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error(err);
      setStatus('No se pudo enviar en este momento. Intenta de nuevo o contáctanos por WhatsApp.');
    } finally {
  ...
  return (
    <section id="contact" ref={ref} className="py-20 sm:py-28">
      <div className="text-center mb-16 fade-in-section">
        <h2 className="text-3xl sm:text-4xl font-bold tracking-tight text-glow-cyan">Acción: auditoría gratis</h2>
        <p className="mt-4 text-lg text-slate-400 max-w-3xl mx-auto">
          Cuéntanos qué estás haciendo manual hoy y te regresamos un plan claro de automatización (rápido, medible y sin humo).
        </p>
      </div>
          ...
          <div className="grid md:grid-cols-2 gap-10">
            ...
            <div className="flex flex-col justify-center">
              ...
              <div className="space-y-4">
                  <a href="https://wa.me/526672475908" target="_blank" rel="noopener noreferrer" className="flex items-center p-4 rounded-lg bg-slate-800/50 hover:bg-slate-800/80 transition border border-slate-700">
                    <p className="font-semibold text-white">WhatsApp</p>
                  </a>
                   <a href="mailto:contacto@silviamx.com" className="flex items-center p-4 rounded-lg bg-slate-800/50 hover:bg-slate-800/80 transition border border-slate-700">
